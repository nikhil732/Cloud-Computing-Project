...
def cloud_3(p_memory,p_status,Failover,cloud_id):
    Treshold_memory=1500 # the minimum requirement of the memory in the cloud for the process to get executed
    ...
    print("Process Directed to t2.small instance")
    print()
    sleep(1)
    ...
    if x==0:
        for i in range(1,41):
            ...
            if p_memory >= Treshold_memory and p_cpu_utilization <= treshold_CPU and p_status>0:
                ...
                print("Process executed without failover in t2.small")
                print()
                sleep(1)
                break
            else:
        ...
        if p_status>0: 
            ...
            print()
            sleep(2)
            choice([cloud_2,cloud_4,cloud_5])(p_memory,p_status,Failover,cloud_id)
